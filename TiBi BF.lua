...
Window = Fluent:CreateWindow({
    Title = "TiBi Hub - Blox Fruit [ fake ]",
    SubTitle = "by hihihaha",
    TabWidth = 155,
...
Main = Window:AddTab({ Title = "Tab Farm", Icon = "⚡️" })
Main:AddButton({
    Title = "click here to receive maru and banana for free",
    Callback = function()
        pcall(function()
...
Toggle = Main:AddToggle("Toggle", { Title = "Super Fast Attack", Default = false })
...
Stack = Window:AddTab({ Title = "Tab multi Farm", Icon = "💫" })
...
Blog = Window:AddTab({ Title = "Tab Fruit + Raid", Icon = "🌳" })
...
PVP = Window:AddTab({ Title = "Tab auto bounty ", Icon = "⚔️" })
local Playerslist = {}
